...
export default function ProjectsHome() {
  return (
    <section className='relative flex flex-col items-center bg-brand-beige-2 md:hidden'>
      <div className='bg-criancaHome bg-cover w-[327px] h-[470px] mb-12 font-black font-poppins text-4xl text-white text-start  flex rounded-md textShadow absolute -translate-y-2/4 left-20'>
